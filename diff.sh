...
diff -q _vimrc ~/_vimrc \
  ...
  & diff -q vimfiles/autoload/plug.vim "C:\Users\Leonid_Petrov1\vimfiles\autoload\plug.vim" \
  & diff -q vimfiles/colors/kuroi.vim "C:\Users\Leonid_Petrov1\vimfiles\colors\kuroi.vim" \
  & diff -q vimfiles/colors/solarized.vim "C:\Users\Leonid_Petrov1\vimfiles\colors\solarized.vim" \
